		...
		<div className="page">
			...
			<Section
				...
				title={
					(
						<span>
							Human-approved AI for <span className="ai-gradient-text">real open-source work</span>
						</span>
			...
			>
				<div className="cta-panel">
					<Link to="/docs/safety-policy" className="button-primary">
						Read Safety Policy Docs
					</Link>
