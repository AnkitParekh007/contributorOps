		...
		<div className="page">
			...
			>
				<div className="demo-note">
					...
					<Link to="/docs" className="demo-note-link">
						Read the setup docs →
					</Link>
				</div>
			</Section>
			...
			>
				<div className="demo-card">
					...
					<div className="demo-terminal">
						<p style={{ margin: "0 0 14px", color: "var(--accent)", fontSize: "0.78rem" }}>
							▸ 3 job-matched issues · avg score 82
						</p>
						{mockIssues.map((issue) => (
							<div key={issue.ref} className="demo-issue-row">
								<span
									className={`score-badge ${issue.score >= 85 ? "score-high" : issue.score >= 78 ? "score-med" : "score-low"}`}
								>
									{issue.score}
								</span>
					...
					>
						<div>
							...
							<p style={{ margin: 0, fontSize: "0.85rem", color: "var(--muted)" }}>
								express-validator/express-validator · open · typescript, enhancement
							</p>
						</div>
						<span className="score-badge score-high" style={{ fontSize: "1rem", minWidth: 54, height: 32 }}>
							91
						</span>
					</div>
							...
							<div key={row.label}>
								...
								>
									...
									<span style={{ color: "var(--accent)" }}>
										{row.score}
										<span style={{ color: "var(--muted)" }}>/{row.max}</span>
									</span>
								</div>
								<div
									style={{
			...
			>
				<div className="demo-card">
					...
					>
						<div>
							...
							<p style={{ margin: 0, fontSize: "0.82rem", color: "var(--muted)" }}>
								Draft PR · express-validator/express-validator
							</p>
						</div>
					...
					<span className="plan-badge plan-pro" style={{ marginTop: 14, display: "inline-flex" }}>
						Pro
					</span>
				</div>
			</Section>
					...
					>
						...
						<span
							style={{
								...
								fontSize: "0.78rem",
								fontWeight: 600,
								background: "rgba(125,240,210,0.16)",
								color: "var(--accent)",
							}}
						>
			...
			>
				<div className="demo-card">
					...
					>
						<p style={{ margin: 0, fontSize: "0.85rem", color: "var(--muted)" }}>
							3 bullets · Markdown export ready
						</p>
					...
					<span className="plan-badge plan-career" style={{ marginTop: 6, display: "inline-flex" }}>
						Career
					</span>
				</div>
			</Section>
			...
			>
				<div className="demo-card">
					...
					<span className="plan-badge plan-career" style={{ marginTop: 14, display: "inline-flex" }}>
						Career
					</span>
				</div>
			</Section>
				...
				<div className="demo-card">
					...
					>
						...
						<p style={{ margin: "0 0 10px", fontWeight: 600 }}>
							Post maintainer question on express-validator #892
						</p>
						<div
							style={{
								padding: "12px 14px",
						...
						>
							Hi @expressjs-team — I'd like to work on improving TypeScript type inference for nested
							validators. I've traced the issue to the validator chain return type. Would you prefer I
							target v7.x or main? Happy to include a migration note in the PR body.
						</div>
					</div>
