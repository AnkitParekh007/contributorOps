...
const PIPELINE = [
  ...
  { label: "AI Scoring",          sub: "Role match, maintainer fit",   iconClass: "pipeline-icon-2", icon: <ShieldCheck size={20} />, },
  { label: "Contribution Plan",   sub: "Files, tests, PR narrative",   iconClass: "pipeline-icon-3", icon: <FileCode2 size={20} />,   },
  { label: "PR Package",          sub: "Quality-checked draft",        iconClass: "pipeline-icon-4", icon: <ShieldCheck size={20} />, },
  { label: "Portfolio Proof",     sub: "Resume, LinkedIn, STAR",       iconClass: "pipeline-icon-5", icon: <BookOpen size={20} />,    },
];
...
export function Features() {
  return (
    <div className="page">
      <Section
        eyebrow="Features"
        title={<span>Contribution intelligence — <span className="ai-gradient-text">end to end</span></span> as unknown as string}
        ...
        return (
          <section key={cat} className="site-section">
            <div className="feature-category-header">
              <span className={`feature-icon-wrap ${CAT_ICON_CLASS[cat]}`} style={{ width: 32, height: 32 }}>
      ...
      >
        <div className="cta-panel">
          <Link to="/docs" className="button-primary">Read the Docs</Link>
