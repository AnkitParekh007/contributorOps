...
export const docs: DocEntry[] = [
  {
    ...
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/product-overview.md",
  },
  {
    ...
    content: localDevMd,
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/local-development.md",
  },
  {
    ...
    content: ghDeployMd,
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/github-pages-deployment.md",
  },
  {
    slug: "safety-policy",
    title: "Safety Policy",
    ...
    content: safetyMd,
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/safety-policy.md",
  },
  {
    ...
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/monetization-plan.md",
  },
  {
    slug: "roadmap",
    title: "Roadmap",
    ...
    content: roadmapMd,
    githubUrl:
      "https://github.com/AnkitParekh007/contributorOps/blob/main/docs/roadmap.md",
  },
];
