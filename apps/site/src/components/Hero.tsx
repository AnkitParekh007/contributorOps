...
const ISSUES = [
  { score: 97, repo: "angular/core",       num: "#48291", label: "TypeScript strict mode",  tag: "Backend",  level: "high" as const },
  { score: 84, repo: "expressjs/express",  num: "#3946",  label: "Error middleware types",  tag: "API",      level: "med"  as const },
  { score: 71, repo: "nestjs/nest",        num: "#12847", label: "Guard decorator edge",    tag: "Platform", level: "low"  as const },
];
  ...
  return (
    <section className="hero reveal-section is-visible">
      ...
      <div className="hero-copy">
        ...
        <p>
          AI-powered contribution intelligence. Discover quality issues, prepare better PRs,
          build a proof-of-work portfolio, and convert real open-source work into resume
          bullets, LinkedIn posts, and interview stories.
        </p>
        ...
        <div className="hero-trust-row">
          <span><strong>100%</strong> human-approved</span>
          <span className="trust-sep" />
          <span><strong>Zero</strong> mass automation</span>
          <span className="trust-sep" />
          <span><strong>Real</strong> proof-of-work</span>
        </div>
      </div>
          ...
          <div className="hd-body">
            ...
            <div className="hd-panel">
              ...
              <div className="hd-checks">
                {CHECKS.map((c) => (
                  <div key={c.label} className={`hd-check ${c.pass ? "hd-check-pass" : "hd-check-warn"}`}>
